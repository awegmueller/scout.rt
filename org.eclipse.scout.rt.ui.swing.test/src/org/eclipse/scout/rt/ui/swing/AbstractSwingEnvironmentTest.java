...
/**
 * Tests for class AbstractSwingEnvironment.
 * 
 * @author awe
 * @since 3.9.0
 */
public class AbstractSwingEnvironmentTest {
   ...
   */
  @Test
  public void testCreateBooleanColumnIcon() throws Exception {
    SwingUtilities.invokeAndWait(new Runnable() {
      @Override
      public void run() {
        Icon icon = new P_Env().createBooleanColumnIcon(new Insets(0, 0, 0, 0));
