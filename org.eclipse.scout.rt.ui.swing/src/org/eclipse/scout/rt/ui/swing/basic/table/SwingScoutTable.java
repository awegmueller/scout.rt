        ...
        if (cell != null) {
          ...
          if (c instanceof JLabel) {
            ...
            if (scoutTable.isCheckable() && column == 0) {
              ...
              checkboxIcon = getSwingEnvironment().createBooleanColumnIcon(new Insets(FONT_PADDING_TOP, 0, 0, 5));
              ...
              checkboxIcon = getSwingEnvironment().createBooleanColumnIcon(new Insets(fontPaddingTop, 0, 0, 0));
